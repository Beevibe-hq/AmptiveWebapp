...
const WAITLIST_GOALS: {
  ...
  },
  {
    role: 'monetize',
    icon: IoGift,
    title: 'Gifts and tips',
    description: 'Set up a support card and get paid directly by the people who follow you.',
    tint: [211, 221, 238],
  },
  {
    role: 'events',
    ...
    description: 'Sell tickets to a show, then check guests in at the door.',
    tint: [223, 213, 240],
  },
  {
    role: 'listener',
    ...
    description: 'Find rooms worth joining and back the creators you already follow.',
    tint: [208, 233, 214],
  },
];
