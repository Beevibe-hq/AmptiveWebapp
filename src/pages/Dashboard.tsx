...
function DashboardHome({ displayName }: { displayName: string }) {
    const [activeMonth, setActiveMonth] = useState("Mar '26");
            ...
            <div className="px-4 md:px-8 pt-6 pb-8 md:pt-8 md:pb-12 flex flex-col items-center">
                ...
                <header className="mb-4 md:mb-5 flex items-center justify-between w-full">
                    <div>
                        ...
                        <p className="text-[15px] text-black/40 font-sans mt-1">Here's what's happening with your events today.</p>
                    </div>
                    <button
                ...
                <div className="w-full mb-8">
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
                        ...
                        <div className="group bg-white border border-black/5 py-5 px-6 rounded-2xl shadow-sm">
                            ...
                            <p className="text-4xl font-bold tracking-tight text-black mt-1">
                                <AnimatedCounter key={`sales-${refreshCount}`} value={245} prefix="₦" suffix="k" />
                            </p>
                        </div>
                        ...
                        <div className="group bg-white border border-black/5 py-5 px-6 rounded-2xl shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                <div className="flex flex-col gap-5">
                                    <span className="text-base font-semibold text-black">Orders</span>
                            ...
                            <p className="text-4xl font-bold tracking-tight text-black mt-1">
                                <AnimatedCounter key={`orders-${refreshCount}`} value={156} />
                            </p>
                        </div>
                        ...
                        <div className="group bg-white border border-black/5 py-5 px-6 rounded-2xl shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                <div className="flex flex-col gap-5">
                                    <span className="text-base font-semibold text-black">Upcoming Events</span>
                                    <div className="p-3 my-2 rounded-full bg-red-50 text-red-600 transition-transform group-hover:scale-110 duration-200 w-fit">
                            ...
                            <h3 className="text-[13px] font-semibold text-black mb-1">Upcoming</h3>
                            <p className="text-4xl font-bold tracking-tight text-black mt-1">
                                <AnimatedCounter key={`upcoming-${refreshCount}`} value={12} />
                            </p>
                        </div>
                        ...
                        <div className="group bg-white border border-black/5 py-5 px-6 rounded-2xl shadow-sm">
                            <div className="flex justify-between items-start mb-4">
                                <div className="flex flex-col gap-5">
                                    <span className="text-base font-semibold text-black">Attendees</span>
                            ...
                            <h3 className="text-[13px] font-semibold text-black mb-1">Total Attendees</h3>
                            <p className="text-4xl font-bold tracking-tight text-black mt-1">
                                <AnimatedCounter key={`attendees-${refreshCount}`} value={285} />
                            </p>
                        </div>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 w-full mb-8 items-start">
                    ...
                    <div className="flex flex-col gap-8 w-full">
                        ...
                        <div className="bg-white border border-black/5 py-5 px-6 rounded-2xl shadow-sm">
                            ...
                            <div className="h-64 relative flex gap-4">
                                <div className="flex flex-col justify-between text-[10px] text-black/40 font-medium py-0 font-sans">
                                    {[
                                        `₦${axisMax}k`,
                                        `₦${Math.round(axisMin + range * 0.66)}k`,
                                        `₦${Math.round(axisMin + range * 0.33)}k`,
                                        `₦${axisMin}k`
                                    ].map((label, i) => <span key={i}>{label}</span>)}
                                </div>
                                <div className="flex-1 relative pt-2 group/chart">
                                    <svg key={activeMonth} className="w-full h-full overflow-visible" viewBox="0 0 400 200" preserveAspectRatio="none">
                                        <defs>
                                        ...
                                        {/* Dashed Grid Lines - Aligned to match 4 dynamic labels (0, 33%, 66%, 100%) */}
                                        <line x1="0" y1="66.66" x2="400" y2="66.66" stroke="#f3f4f6" strokeWidth="1" strokeDasharray="4 4" />
                                        <line x1="0" y1="133.33" x2="400" y2="133.33" stroke="#f3f4f6" strokeWidth="1" strokeDasharray="4 4" />
                                                ...
                                                <g key={i} className="group/slice cursor-crosshair">
                                                    ...
                                                    <g className="opacity-0 translate-y-2 group-hover/slice:translate-y-0 group-hover/slice:opacity-100 transition-all duration-300 ease-out pointer-events-none">
                                                        ...
                                                        <rect
                                                            ...
                                                            fill="#2563eb"
                                                        />
                                                        {/* Sharp Bottom Point targeting the circle */}
                                                        <polygon
                            ...
                            <div className="flex justify-between mt-4 text-[10px] font-sans font-medium pl-10 pr-2">
                                {['Wk 1', 'Wk 2', 'Wk 3', 'Wk 4'].map((label, index) => {
                                    const isActive = index === activeData.points.length - 1;
                                    return (
                                        <span key={label} className={isActive ? 'text-black' : 'text-black/40'}>
                                            {label}
                                        </span>
                                    );
                                })}
                    ...
                    <div className="flex flex-col gap-8 w-full">
                        ...
                        <div className="flex flex-col gap-4 mt-6">
                            <h3 className="text-[15px] font-bold text-black">Quick Links</h3>

                            <div className="flex flex-wrap gap-4">
                                <button className="flex items-center gap-2 bg-black/5 hover:bg-black text-black/80 hover:text-white px-4 py-2 rounded-full transition-colors group">
